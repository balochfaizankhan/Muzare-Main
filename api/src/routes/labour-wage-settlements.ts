    ...
    try {
      ...
      const result = await db.transaction(async (tx) => {
        ...
        const settlementPayload = {
          ...
          includedEarnings: preview.includedEarnings ?? [],
          ...
          individualLabourWorkWages: preview.individualLabourWorkWages ?? 0,
          groupLabourWorkWages: preview.groupLabourWorkWages ?? 0,
    ...
    const result = await db.transaction(async (tx) => {
      ...
      if (financialChanges) {
        ...
        const nextPayload = {
          ...
          individualLabourWorkWages: nextTotals.individualLabourWorkWages,
          groupLabourWorkWages: nextTotals.groupLabourWorkWages,
