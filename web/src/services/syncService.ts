...
const tables = {
  ...
  advance: offlineDb.advances, wageRate: offlineDb.wageRates, labourPayment: offlineDb.labourPayments, productionEntry: offlineDb.productionEntries, inventoryEntry: offlineDb.inventoryEntries,
} as const;
