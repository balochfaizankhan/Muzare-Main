...
const permissionsByRole: Record<AppUser["role"], readonly Permission[]> = {
  ...
  workspace_owner: ["APPROVE_EXPENSE", "APPROVE_ATTENDANCE", "APPROVE_SALE", "APPROVE_DISPATCH", "MANAGE_TEAM", "MANAGE_FARMS", "MANAGE_SEASONS", "MANAGE_EXPENSE_CATEGORIES", "MANAGE_RECORDS", "SUBMIT_RECORDS", "VIEW_REPORTS"],
