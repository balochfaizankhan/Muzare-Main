...
export const roleModulePermissions: Record<WorkspaceRole, Record<WorkspaceModule, Record<WorkspaceModuleAction, boolean>>> = {
  workspace_owner: Object.fromEntries(["dashboard", "workforce", "attendance", "advances", "wages", "expenses", "sales", "dispatch", "inventory", "accounts", "reports", "settings", "team"].map((module) => [module, { ...allActions }])) as Record<WorkspaceModule, Record<WorkspaceModuleAction, boolean>>,
  workspace_manager: { dashboard: { ...viewOnly }, workforce: { ...viewCreateEdit }, attendance: { ...viewCreateEdit, approve: true }, advances: { ...viewCreateEdit }, wages: { ...viewCreateEdit, export: true }, expenses: { ...viewCreateEdit }, sales: { ...viewCreateEdit }, dispatch: { ...viewCreateEdit }, inventory: { ...viewCreateEdit }, accounts: { ...viewOnly }, reports: { ...viewOnly, export: true }, settings: { ...viewOnly }, team: { ...viewOnly } },
  supervisor: { dashboard: { ...viewOnly }, workforce: { ...viewOnly }, attendance: { ...viewCreateEdit }, advances: { ...viewCreateEdit }, wages: { ...viewOnly, export: true }, expenses: { ...viewCreateEdit }, sales: { ...viewCreateEdit }, dispatch: { ...viewCreateEdit }, inventory: { ...viewCreateEdit }, accounts: { ...viewOnly }, reports: { ...viewOnly }, settings: { ...viewOnly }, team: { ...viewOnly } },
  accountant: { dashboard: { ...viewOnly }, workforce: { ...viewOnly }, attendance: { ...viewOnly }, advances: { ...viewCreateEdit, export: true }, wages: { ...viewCreateEdit, export: true }, expenses: { ...viewCreateEdit, export: true }, sales: { ...viewOnly }, dispatch: { ...viewOnly }, inventory: { ...viewOnly }, accounts: { ...viewCreateEdit, export: true }, reports: { ...viewOnly, export: true }, settings: { ...viewOnly, view: false }, team: { ...viewOnly, view: false } },
  operator: { dashboard: { ...viewOnly }, workforce: { ...viewOnly }, attendance: { ...viewCreate }, advances: { ...viewCreate }, wages: { ...viewOnly }, expenses: { ...viewCreate }, sales: { ...viewCreate }, dispatch: { ...viewCreate }, inventory: { ...viewCreate }, accounts: { ...viewOnly, view: false }, reports: { ...viewOnly, view: false }, settings: { ...viewOnly, view: false }, team: { ...viewOnly, view: false } },
  viewer: Object.fromEntries(["dashboard", "workforce", "attendance", "advances", "wages", "expenses", "sales", "dispatch", "inventory", "accounts", "reports", "settings", "team"].map((module) => [module, { ...viewOnly }])) as Record<WorkspaceModule, Record<WorkspaceModuleAction, boolean>>,
};
