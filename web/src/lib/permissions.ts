...
const permissionsByRole: Record<AppUser["role"], readonly Permission[]> = {
  ...
  workspace_owner: ["APPROVE_EXPENSE", "APPROVE_ATTENDANCE", "APPROVE_SALE", "APPROVE_DISPATCH", "MANAGE_TEAM", "MANAGE_RECORDS", "SUBMIT_RECORDS", "VIEW_REPORTS"],
  workspace_manager: ["APPROVE_EXPENSE", "APPROVE_ATTENDANCE", "APPROVE_SALE", "APPROVE_DISPATCH", "MANAGE_TEAM", "MANAGE_RECORDS", "SUBMIT_RECORDS", "VIEW_REPORTS"],
